...
public class Mailing {
    private static final String TEST_EMAIL = "financialhub.contactstaff@gmail.com";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT, GsonFactory jsonFactory )
            throws IOException {
        // Load client secrets.
        InputStream in = Mailing.class.getResourceAsStream("/client_secret_828149163039-rq534ehrlsh3b4dq7s0f1ue3thahh21v.apps.googleusercontent.com.json");
    ...
    /*public static void main(String[] args) throws MessagingException, GeneralSecurityException, IOException {
        new Mailing().sendMail("Waste Wise","l m3allem","ayoub.gombra@gmail.com");
